...
public class MyProjects extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		out.println("<p>The projects that you have created are listed here. You may add/edit/delete your projects. To set up a project click setup. To edit the properties of a project, click properties.</p><br>");
		...
		try {
			...
			for (Project proj : list) {
				...
				String ed = String.format(
						"<button class='edit' recno='%d'>Edit</button>",
						proj.getRecordID());
				String del = String.format(
						"<button class='del' recno='%d'>Delete</button>",
						proj.getRecordID());
				String set = String.format(
						"<button class='set' recno='%d'>Setup</button>",
						proj.getRecordID());
				String prop = String.format(
						"<button class='prop' recno='%d'>Properties</button>",
						proj.getRecordID());
