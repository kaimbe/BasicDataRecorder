...
public class ManageUsers extends HttpServlet {
    ...
    private void userSection( PrintWriter out )
    throws IOException
    {
        ...
        try {
            ...
            for( String user : userAuth.getUserNames() ) {
                out.println("<tr>");
                out.printf("<td><button user='%s' class='delete-user'>Delete</button></td>%n", user);
                ...
                for ( String role : roles ) {
                    ...
                    String cb = String.format( "<input %s type='checkbox' value='%s'/>",
                        checked, role );
                    out.printf("<label>%s %s</label> ", cb, role);
                }
                out.println("</td>");
                out.printf("<td><button user='%s' class='update-roles'>Update</button></td>", user);
                out.println("</tr>");
            }
            out.println("</table>");
        }
