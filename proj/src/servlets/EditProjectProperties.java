    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try {
        	...
        	if (((setting.getUsers() == null) || (setting.getUsers().equals(""))) && ((setting.getDescription() == null) || (setting.getDescription().equals("")))) {
            	...
            	out.println("<label>Project Description: <br><textarea id='des' rows='5' cols='30'>" + setting.getDescription() + "</textarea></label><br>");
            	out.println("<label>Project Users: <br><textarea id='usrs' rows='5' cols='30'>" + setting.getUsers() + "</textarea></label><br>");
            }
        }
