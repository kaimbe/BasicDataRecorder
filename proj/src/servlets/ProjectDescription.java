...
public class ProjectDescription extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			out.println("<p>Listed are all the data records for this project. The project description and the list of users that may contribute towards the project are listed below. To view/add/edit/delete your records for this project click edit project. To view reports for this project, click reports.</p><br>");
			...
			try {
				...
				out.println("<label>Project Description: <br><p>"
						+ setting.getDescription() + "</p></label><br>");
				out.println("<label>Project Users: <br><p>"
						+ setting.getUsers() + "</p></label><br>");
			...
			out.println("<input type='button' id='view_reports' value='View Reports'>");
		} catch (NullPointerException ex) {
			out.println("<p>This project is not set up yet. The owner needs to set up this project before others may contribute.</p>");
		}
	...
	protected void doPost(HttpServletRequest request,
		...
		if (pathInfo != null && cmd.startsWith("/edit")) {
			...
			return;
		} else if (pathInfo != null && cmd.startsWith("/report")) {
			log("redir: " + user + "=" + projName);
			response.setContentType("application/json");
			out.print(gson.toJson(projName));
			return;
